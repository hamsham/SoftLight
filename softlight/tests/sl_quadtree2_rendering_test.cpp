...
#include "softlight/SL_Quadtree2.hpp"
...
typedef SL_QuadTree2<int, 8> QuadtreeType;
...
void init_quadtree(QuadtreeType& tree, float randomPx, float randomPy)
{
    tree.clear(ls::math::vec2{0.f, 0.f}, 512.f);

    // insert the world node
    tree.insert(ls::math::vec2{0.f, 0.f}, 512.f, 0);

    // insert test nodes
    tree.insert(ls::math::vec2{-25.f,   3.f},   3.f, 1);
    tree.insert(ls::math::vec2{ 242.f,  3.f},   2.f, 2);
    tree.insert(ls::math::vec2{-6.f,   -64.f},  3.f, 3);
    tree.insert(ls::math::vec2{ 9.f,    426.f}, 5.f, 4);
    tree.insert(ls::math::vec2{-100.f, -129.f}, 3.f, 5);
    tree.insert(ls::math::vec2{-392.f, -37.f},  1.f, 6);
    tree.insert(ls::math::vec2{-52.f,   300.f}, 3.f, 7);
    tree.insert(ls::math::vec2{-25.f,   4.f},   1.f, 8);

    // insert random node
    tree.insert(ls::math::vec2{randomPx, randomPy}, 3.f, 9);
}
...
int main()
{
    ...
    typename QuadtreeType::allocator_type treeAllocator{};
    QuadtreeType quadtree{ls::math::vec2{0.f, 0.f}, 1.f, &treeAllocator};
    init_quadtree(quadtree, 1.f, 1.f);
    ...
    while (!shouldQuit)
    {
        ...
        else
        {
            ...
            init_quadtree(quadtree, radomPx, radomPy);
