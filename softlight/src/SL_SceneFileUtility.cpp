...
) noexcept
{
    ...
    return set_mesh_vertex_data(pVbo, sl_pack_vertex_2_10_10_10(math::normalize(n)));
}
...
) noexcept
{
    ...
    return set_mesh_vertex_data(pVbo, sl_pack_vertex_2_10_10_10(math::normalize(t)));
}
