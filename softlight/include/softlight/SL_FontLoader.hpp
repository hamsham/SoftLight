...
#ifndef SL_FONT_LOADER_HPP
#define SL_FONT_LOADER_HPP
 ...
 * to "const glyph*".
-----------------------------------------------------------------------------*/
class SL_FontLoader final : public ls::utils::Resource {
  public:
  ...
  public:
     ...
     */
    SL_FontLoader(const SL_FontLoader&) = delete;
    /**
     ...
     *
     * @param fr
     * An r-value reference to another SL_FontLoader object.
     */
    SL_FontLoader(SL_FontLoader&& fr);
     ...
     */
    virtual ~SL_FontLoader() override;

    /**
     * @brief Copy Operator - DELETED
     */
    SL_FontLoader& operator=(const SL_FontLoader&) = delete;
     ...
     */
    SL_FontLoader& operator=(SL_FontLoader&& fr);
     ...
     */
    const SL_FontGlyph* get_glyphs() const;
...
-------------------------------------*/
inline bool SL_FontLoader::load_file(const std::wstring& filename, unsigned pixelSize) {
 ...
 * Load a font file using the default font size.
-------------------------------------*/
inline bool SL_FontLoader::load_file(const std::wstring& filename) {
 ...
 * Load a font file using the default font size.
-------------------------------------*/
inline bool SL_FontLoader::load_file(const std::string& filename) {
 ...
 * Get the size of the currently loaded fonts
-------------------------------------*/
inline unsigned SL_FontLoader::get_font_size() const {
    return glyphSize;
}
 ...
 * Get the array of glyphs used by *this
-------------------------------------*/
inline const SL_FontGlyph* SL_FontLoader::get_glyphs() const {
    return reinterpret_cast<SL_FontGlyph*> (pData);
}

/*-------------------------------------
 * Get the number of glyphs that have been loaded
-------------------------------------*/
inline unsigned SL_FontLoader::get_num_glyphs() const {
    return numGlyphs;
}
 ...
 * Get the size of the widest glyph
-------------------------------------*/
inline ls::math::vec2i SL_FontLoader::get_max_glyph_size() const {
    return maxGlyphSize;
}



#endif  /* SL_FONT_LOADER_HPP */
