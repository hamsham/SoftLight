...
-------------------------------------*/
enum SL_AnimPlayMode
{
    SL_ANIM_PLAY_ONCE,
    SL_ANIM_PLAY_REPEAT,
    SL_ANIM_PLAY_DEFAULT = SL_AnimPlayMode::SL_ANIM_PLAY_ONCE
};
...
class SL_Animation
{
  ...
  public: // public member functions
     ...
     */
    SL_Animation(const SL_Animation& a) noexcept;
     ...
     */
    SL_Animation(SL_Animation&& a) noexcept;
     ...
     */
    SL_Animation& operator=(const SL_Animation& a) noexcept;
     ...
     * @return A reference to *this.
     */
    SL_Animation& operator=(SL_Animation&& a) noexcept;
     ...
     */
    SL_AnimPlayMode play_mode() const noexcept;
     ...
     * a looping or non-looping Animation.
     */
    void play_mode(const SL_AnimPlayMode animMode) noexcept;
     ...
     *
     * @return A SL_AnimPrecision-precision float, containing the number of ticks
     ...
     *
     * @param ticks
     * A SL_AnimPrecision-precision float, containing the number of ticks that an
     * Animation will play.
     */
    void duration(const SL_AnimPrecision ticks) noexcept;

    /**
     * @brief Get playback speed, in ticks per second, that *this object
     * will run at.
     *
     * @return A SL_AnimPrecision-precision float, containing the speed of *this
     * Animation in ticks/sec.
     */
    SL_AnimPrecision ticks_per_sec() const noexcept;
     ...
     *
     * @param numTicks
     * A SL_AnimPrecision-precision float, containing the speed of *this Animation in
     * ticks/sec.
     */
    void ticks_per_sec(const SL_AnimPrecision numTicks) noexcept;
     ...
     */
    void animate(SL_SceneGraph& graph, const SL_AnimPrecision percentDone) const noexcept;
     ...
     */
    void animate(SL_SceneGraph& graph, const SL_AnimPrecision percentDone, size_t baseTransformId) const noexcept;
     ...
     */
    void init(SL_SceneGraph& graph, const bool atStart = true) const noexcept;
...
/*-------------------------------------
 * Set the SL_Animation name
-------------------------------------*/
template<typename std_string_type>
void SL_Animation::name(std_string_type&& name) noexcept
{
