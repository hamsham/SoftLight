...
#ifndef SR_UTILITY_HPP
#define SR_UTILITY_HPP
...
template <typename T>
using SR_AlignedVector = std::vector<T, ls::utils::AlignedAllocator<T>>;



#endif /* SR_UTILITY_HPP */
