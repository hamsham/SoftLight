...
enum SR_WinEventType : uint32_t
{
    ...
    WIN_EVENT_MOUSE_BUTTON_DOWN = 0x00000001, // SR_MouseButtonEvent
    WIN_EVENT_MOUSE_BUTTON_UP   = 0x00000002,

    WIN_EVENT_MOUSE_WHEEL_MOVED = 0x00000004, // SR_WheelEvent

    WIN_EVENT_MOUSE_MOVED       = 0x00000008, // SR_MousePosEvent
    WIN_EVENT_MOUSE_ENTER       = 0x00000010,
    WIN_EVENT_MOUSE_LEAVE       = 0x00000020,

    WIN_EVENT_KEY_DOWN          = 0x00000040, // SR_KeyEvent
    WIN_EVENT_KEY_UP            = 0x00000080,

    WIN_EVENT_CLOSING           = 0x00000100, // SR_WinUpdateEvent
