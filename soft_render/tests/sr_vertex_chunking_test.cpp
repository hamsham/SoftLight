...
int main()
{
    ...
    {
        sr_calc_indexed_parition<vertsPerPrim, lastThreadHasLess>(totalVerts, numThreads, i, start, end);
    ...
    sr_calc_indexed_parition<vertsPerPrim, lastThreadHasLess>(totalVerts, numThreads, 0, start, end);
    stdChunkSize = end;
